...
/// CONSTRUCTORS
     ...
     * @param   orientation     The entity's orientation, given as a rotation from the default
...
// Alterers
    ...
    /**
     * Move the entity by a given vector with respect to the global basis.
     */
    ...
    /**
     * Rotate the entity by a given rotation defined with respect to the global basis.
     */
...
// Evolution
    ...
    /**
     * Update the entity's position and orientation, as if a given amount of
     * time has passed.
     *
    ...
    /**
     * Change the rate-related parameters of the entity as if a force
     * of given magnitude acted on the entity at a given displacement
     * from its barycenter.
     *
     * @param   t   The amount of time to simulate the passage of, in seconds.
